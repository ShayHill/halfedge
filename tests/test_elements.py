...
class TestVert:
    def test_return_empty_edges_if_no_edge_set(self):
    ...
    def test_return_empty_neighbors_if_no_edge_set(self):
...
class TestEdge:
    def test_raise_attribute_error_if_orig_not_set(self):
    ...
    def test_raise_attribute_error_if_face_not_set(self):
    ...
    def test_vert_faces(self, edge_index: int):
    ...
    @pytest.mark.parametrize("edge_index", range(3))
    def test_vert_holes(self, edge_index: int):
